...
| 字符 | 首字节 | 高4位 (r4) | r4 << 4 | 编码预测 | 实际编码 | 匹配 |
|------|--------|-----------|---------|----------|----------|------|
| 汰 | 0x70 | 7 | 0x70 < 0x80 | 标准 (15列) | 标准 | ✅ |
| 汲 | 0x72 | 7 | 0x72 < 0x80 | 标准 (15列) | 标准 | ✅ |
| 汶 | 0x76 | 7 | 0x76 < 0x80 | 标准 (15列) | 标准 | ✅ |
| 汸 | 0x78 | 7 | 0x78 < 0x80 | 标准 (15列) | 标准 | ✅ |
| 決 | 0x7A | 7 | 0x7A < 0x80 | 标准 (15列) | 标准 | ✅ |
| 汾 | 0x7E | 7 | 0x7E < 0x80 | 标准 (15列) | 标准 | ✅ |
| 沂 | 0x82 | 8 | 0x82 >= 0x80 | 特殊 (14列) | 特殊 | ✅ |
| 沄 | 0x84 | 8 | 0x84 >= 0x80 | 特殊 (14列) | 特殊 | ✅ |
...
| 字符 | Unicode | metadata[0] | r4 << 4 | 预期编码 | 实际编码 | 匹配 |
|------|---------|-------------|---------|----------|----------|------|
| 沨 | U+6CA8 | 0x39 | 0x390 < 0x80 | 标准 | 标准 | ✅ |
| 沦 | U+6CA6 | 0xF1 | 0xF10 >= 0x80 | 特殊 | 特殊 | ✅ |
