...
### 问题 2: lsls r3, r3, #0x10 的目的

**操作**: r3 = r3 << 16
**疑问**: 为什么要左移 16 位？是行计数还是其他用途？

### 问题 3: lsrs r0, r3, #2 的结果为何被丢弃？

**代码序列**:
```assembly
0x133662: lsrs r0, r3, #2      ; r0 = r3 >> 2
0x133664: strh r3, [r7, #0xe]  ; 存储的是 r3，不是 r0！
```

**疑问**: 右移操作的结果没有被使用，为什么？

### 问题 4: strh r3, [r7, #0xe] 存储的是什么？

**操作**: 将 r3 存储到渲染上下文偏移 0xe 处
**疑问**: 这个位置的用途是什么？
